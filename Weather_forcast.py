...
def weather_data():
    city = city_entry.get()
    user_api = "3115c8cdb378c863c277885832e6fac6"
...
city_label = Label(window,text="Enter City Name ", width="30",font="Times 30 bold", bg='White', fg='red', height=1)
city_label.grid(row=0,column=0)

city_entry = tkinter.Entry(window,text="City",width=30,borderwidth=7)
city_entry.config(font=("Arial",30,"bold"))
city_entry.grid(row=1)

submit_btn = Button(window,text="Get Data",font="Times 20 bold",bd=3,width="20",borderwidth=5 , bg='black',fg='white',command=weather_data)
